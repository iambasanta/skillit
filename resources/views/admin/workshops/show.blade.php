            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between my-4">
                        ...
                        <a href="{{ route('admin.workshops.index') }}" class = 'inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-xs uppercase tracking-widest hover:bg-gray-300 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150'>
                            {{ __('Go Back') }}
                        </a>

                        <x-button class="ml-4">
                            <a href="{{ route('admin.workshops.registrants.download',$workshop) }}">
                                {{ __('Save as PDF') }}
                            </a>
                        </x-button>
                    </div>
